  ...
  methods: {
    ...
    async login() {
      ...
      if (data.message === "成功") {
        ...
        rights.push("conditionsManage");
        rights.push("auditMode");
        rights.push("businessPortraits");
        rights.push("rulesConditions");
        rights.map((right) => {
...
.pierce-login {
  ...
  &-content {
    ...
    &-left {
      ...
      padding-top: 100px;
      padding-left: 40px;
      background: url("~@/assets/images/img/login_background_2.png") no-repeat
        center;
