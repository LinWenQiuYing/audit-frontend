<template>
  <div class="add-model" id="add-model" ref="addModel">
    ...
    <div id="add-model-content" class="add-model-content">
      ...
      <div class="content-top">
        <div class="content-top-item">
          ...
          <div class="item-box">
            ...
            />
            <span class="item-text" v-else>请先选择模板</span>
          </div>
        </div>
        <div class="content-top-item">
      ...
      <div class="sub-title" v-if="details.createType === 2">脚本展示</div>
    ...
    async handleConfirm() {
      ...
      if (this.details.createType === 2) {
        ...
        for (let i = 0; i < this.$refs.scriptResults.dataList.length; i++) {
          ...
          console.log("🚀 ~ handleConfirm ~ element:", element);
      ...
      if (!flag) {
        ...
        try {
          ...
          this.$message.destroy();
          const msg =
            this.detailsType === "edit" ? "模型修改失败！" : "模型创建失败！";
