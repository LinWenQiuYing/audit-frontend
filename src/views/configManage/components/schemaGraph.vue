<template>
  <div class="schema-graph" ref="schemaGraph">
    ...
    <div class="adapt-screen" @click="handleFit">
      <img src="@/assets/images/img/size_change.png" title="适应窗口" />
    </div>
  </div>
</template>
<script>
  ...
  methods: {
    ...
    createGraph() {
      ...
      this[`${this.graphObj}`].cy
        ...
        .css({
          color: this.isModel ? "#000" : "#A8AEB4",
          "text-opacity": this.isModel ? 0.85 : 1,
          "text-wrap": "wrap",
          "text-max-width": "420",
    ...
    addEdge() {
      ...
      const res = checkThreshold(data, this.$schema2, "1", false, true);
