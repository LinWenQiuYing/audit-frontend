...
export default {
    ...
    return {
      ...
      pagination: {
        ...
        onShowSizeChange: (current, size) => {
          ...
          sessionStorage.setItem("warningInfoCurrent", 1);
  ...
  async mounted() {
    console.log("riskInfo", this.riskInfo);
    if (this.riskInfo.ruleId) {
      // 从全量搜索跳转过来
      this.warningRule = this.riskInfo.ruleName;
      this.warningClass = this.riskInfo.categoryId;
    }
