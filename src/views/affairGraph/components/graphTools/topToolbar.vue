  ...
  <div class="top-tool-bar">
    <div class="top-tool-bar-right">
      ...
      <div class="canvas-tool-items" @click="handleFit">
        <img src="@/assets/images/img/size_change.png" alt="size_change" />
...
export default {
  ...
  computed: {
    ...mapState("graphOptions", ["searchVertex"]),
  },
  mounted() {
    if (this.$graph) {
  ...
  methods: {
    changeLayout(value) {
      ...
      this.$emit("isCloseGraphMenu", false);
      value === "cise"
