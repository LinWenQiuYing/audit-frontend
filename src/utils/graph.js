...
import iconSeries from "@/assets/theme/iconSeries.js";
// @ts-ignore
...
const BACKGROUND_IMAGE_RATIO = "75%";
...
export function elementAttr(json, attr, defaultVal) {
  const field = json.property["__" + attr];
  if (!field) {
    return defaultVal;
  }
...
export function makeRequestCancellable(method, url, body) {
  ...
  if (process.env.NODE_ENV === "development") {
    Object.assign(config, {
      // headers: {
      //   authorization:
      //     // "Bearer eyJhbGciOiJIUzUxMiJ9.eyJ1c2VybmFtZSI6InRlc3QiLCJyb2xlcyI6IltcI1NPUEhPT19BRE1JTlwiXSIsInNjb3BlIjoiZXh0ZXJuYWwiLCJleHAiOjQ3NzgxODcyNzAsImlhdCI6MTYyNDU4NzI3MH0.m3yC4dqDRxwCMtuAEI0I9G17e9InxrculCeAQy0rHq-uSFjpctTFs5mb30SSFlC_7Dsj_JAl8d7RGjHSUpsPsg",
