...
export async function organizationManageDelete(json) {
...
export async function organizationManageAdd(json) {
...
export async function getOrganzationdelete(id) {
...
//资源管理资源详情
export async function querySource(json) {
  const res = await axiosInstance.post(`${primUrl}/querySource`, json, {
    timeout: -1,
  });
  return res;
}
